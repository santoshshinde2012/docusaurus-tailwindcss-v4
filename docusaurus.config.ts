...
const config: Config = {
  ...
  organizationName: 'santoshshinde2012', // Usually your GitHub org/user name.
  projectName: 'docusaurus-tailwindcss-v4', // Usually your repo name.
          ...
          items: [
            {
              ...
              href: 'http://stackoverflow.com/users/4319438/santosh-shinde',
            },
            {
              label: 'X',
              href: 'https://twitter.com/shindesan2012',
            },
          ],
        },
        {
